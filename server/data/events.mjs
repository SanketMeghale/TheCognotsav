...
export const eventSeed = [
  ...
  },
  {
    ...
    registration_fee_label: 'INR 200 per team',
    min_members: 1,
    max_members: 4,
    max_slots: 40,
    is_team_event: true,
  ...
  {
    slug: 'techxcelerate-poster-presentation',
    name: 'Techxcelerate (Poster Presentation)',
    category: 'Technical',
    date_label: '08 Apr 2026',
    time_label: '12:00 PM',
    venue: 'CE Department',
    description:
      'Poster presentation entry for technical ideas and research showcases, kept separate from project expo registrations.',
    prize: 'INR 5,000',
    registration_fee: 50,
  ...
  },
  {
    ...
    payment_upi: '9850560091@ibl',
    payment_payee: 'TRUPTI SANJAY JADHAV',
